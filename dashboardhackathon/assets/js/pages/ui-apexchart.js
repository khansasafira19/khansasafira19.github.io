var lineOptions = {
    ...
    series: [{
        ...
        data: [0.2546, 0.2546, 0.3636, 0.3201, 0.2851, 1.1238, 0.1458, 0.3459],
    }, ],
    xaxis: {
...
let barSvrOptions = {
    ...
    series: [{
            ...
            data: [37.16051104, 28.43297197, 22.41, 6.77360102, 3.8260097,
                ...
                12.49757779, 13.14530789, 9.870200933, 8.714043676, 10.20401755, 11.28060674, 11.57639824, 15.94589528
...
var areaOptions = {
    series: [{
        ...
        {
            name: "MAPE",
            data: [0.2063, 0.2063, 0.2498, 0.0715, 0.3627, 0.7162, 0.2001, 0.2473],
        },
        {
            name: "MAE",
            data: [2.216, 2.2163, 2.9776, 0.7904, 3.8846, 8.0499, 2.1527, 2.9933],
        },
    ],
    chart: {
        height: 350,
